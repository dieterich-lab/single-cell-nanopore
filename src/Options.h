...
/*
	...
	addText(parser._toolDoc, "\\fBRTAIL:\\fP use only last n bases, see tail-length options",       false);*/
 	...
 	addText(parser._toolDoc, "\\fBsingleCellPipe\\fP \\fB-r\\fP reads.bam \\fB-t\\fP target \\fB-w\\fP whitelist.fasta \\fB-as\\fP CTACACGACGCTCTTCCGATCT", false);
