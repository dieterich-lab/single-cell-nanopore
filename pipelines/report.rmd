...
# Nanopore reads
## Feature distributions
```{r, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.width=8, fig.height=6}
...
```{r, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.width=8, fig.height=6}
