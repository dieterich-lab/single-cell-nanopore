...
We compared the features (Figure \ref{fig:realcomp}) and scores (Figure \ref{fig:realcompscore}) of the Nanopore reads which have either assigned to a barcode by ScNapBar, or Sicelore, or both. 
